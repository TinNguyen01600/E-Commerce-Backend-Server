...
namespace Server.Service.src.DTO
{
    ...
    public class AddressEditDto
    {
        ...
        public AddressEditDto(string addressLine, string street, string city, string country, string postcode, string phoneNumber, string firstName, string lastName, string landmark)
        {
